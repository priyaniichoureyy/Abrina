...
export default function Home() {
  ...
  return (
    <section className="min-h-screen flex flex-col bg-[#F8FAFC] text-gray-900 font-sans">
      ...
      >
        ...
        <p className="text-xl md:text-2xl text-gray-100 max-w-2xl leading-relaxed mb-10 text-center">
          Explore ABRINA’s tools designed for your role, assisting police, forensic experts, postmortem teams, and doctors in identifying potential poisoning cases quickly and accurately.
        </p>
    ...
    ABRINA is a smart forensic tool designed to enhance the process of poison detection in the human body.
    It assists <span className="font-semibold text-[#1E3A5F]">forensic experts</span> in increasing accuracy and speed during toxicology analysis,
    supports <span className="font-semibold text-[#1E3A5F]">medical professionals</span> in identifying rare poisoning cases,
    and helps <span className="font-semibold text-[#1E3A5F]">police personnel</span> determine whether poisoning is involved in a case with scientific precision.
  </p>
      </div>  
      <div
        id="contact"
        className="bg-[#1E3A5F] text-white py-20 px-8 text-center shadow-inner mx-10 mt-12 rounded-3xl"
      >
        <h2 className="text-4xl font-bold text-[#0891B2] mb-6">Contact</h2>
        <p className="text-lg max-w-3xl mx-auto mb-6">
          For inquiries or support, reach out to us at <strong>contact@abrina.com</strong>.
        </p>
        <button
          className="bg-[#0891B2] px-8 py-3 rounded-full font-semibold text-lg shadow-lg hover:bg-[#0E7490] hover:scale-105 transition-all duration-300"
        >
          Send Message
        </button>
      </div>
